...
object ProblemHttpPlanDefinitions:
  ...
  final case class RegisteredPlans(
    listProblems: Plain[domains.auth.model.AuthUser, domains.problem.application.input.ProblemListRequest, shared.model.PageResponse[domains.problem.application.output.ProblemSummary]],
    listProblemSuggestions: Plain[domains.auth.model.AuthUser, domains.problem.application.input.ProblemSearchQuery, List[domains.problem.application.output.ProblemSuggestion]],
    createProblem: WithTransaction[domains.auth.model.AuthUser, domains.problem.application.input.CreateProblemRequest, domains.problem.application.ProblemCommands.CreateProblemResult],
    ...
    deleteProblemDataPath: WithTransaction[domains.auth.model.AuthUser, (domains.problem.model.ProblemSlug, domains.problem.application.input.DeleteProblemDataPathRequest), domains.problem.application.ProblemCommands.DeleteProblemDataResult],
    ...
    updateProblem: WithTransaction[domains.auth.model.AuthUser, (domains.problem.model.ProblemSlug, domains.problem.application.input.UpdateProblemRequest), domains.problem.application.ProblemCommands.UpdateProblemResult],
