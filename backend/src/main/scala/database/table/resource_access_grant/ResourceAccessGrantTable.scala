package database.table.resource_access_grant
...
object ResourceAccessGrantTable:
  ...
  private val backfillLegacyViewerGrantSQL: String =
    """
  ...
  private val listForResourceSQL: String =
    """
  ...
  private val deleteAllForResourceSQL: String =
    """
  ...
  private val hasDirectUserGrantSQL: String =
    """
      |select 1
      |from resource_access_grants
      |where resource_kind = ?
  ...
  private val hasGrantedUserGroupSQL: String =
    """
      |select 1
  ...
  private val deleteForResourceAndRoleSQL: String =
    """
      |delete from resource_access_grants
      |where resource_kind = ? and resource_id = ? and grant_role = ?
      |""".stripMargin
