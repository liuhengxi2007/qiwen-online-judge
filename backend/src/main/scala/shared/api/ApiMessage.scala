...
object ApiMessages:
  ...
  val ratingContestAlreadyAppended: ApiMessage = ApiMessage("api.error.rating.contest_already_appended")
  val ratingContestOutOfOrder: ApiMessage = ApiMessage("api.error.rating.contest_out_of_order")
  ...
  val hackNotFound: ApiMessage = ApiMessage("api.error.hack.not_found")
