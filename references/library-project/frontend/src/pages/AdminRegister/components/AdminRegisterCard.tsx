...
import type { AdminRegisterFormState } from '../hooks/useAdminRegisterForm'

export function AdminRegisterCard({ form }: { form: AdminRegisterFormState }) {
  return (
    <Card className="border-white/70 bg-white/82 py-0 shadow-[0_30px_80px_rgba(15,23,42,0.12)] backdrop-blur-xl">
      <CardHeader className="gap-3 border-b border-slate-200/70 px-7 py-7 sm:px-8">
        ...
        <CardDescription className="text-sm text-slate-500">请输入管理员注册信息</CardDescription>
      </CardHeader>
