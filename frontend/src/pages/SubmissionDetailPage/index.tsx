...
import { parseSubmissionId } from '@/objects/submission/submission-parsers'
import type { SubmissionId } from '@/objects/submission/SubmissionId'
import { useProblemTitleDisplayMode } from '@/pages/hooks/problem/use-problem-title-display'
import { useSubmissionDetailActions } from '@/pages/hooks/submission/use-submission-detail-actions'
import { useSubmissionDetailQuery } from '@/pages/hooks/submission/use-submission-detail-query'
