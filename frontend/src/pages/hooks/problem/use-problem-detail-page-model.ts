...
import { useProblemDeleteAction } from '@/pages/hooks/problem/use-problem-delete-action'
import { useProblemDetailQuery } from '@/pages/hooks/problem/use-problem-detail-query'
import { useProblemEditorState } from '@/pages/hooks/problem/use-problem-editor-state'
import { useProblemUpdateAction } from '@/pages/hooks/problem/use-problem-update-action'
