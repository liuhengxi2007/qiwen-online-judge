...
async function loadHarness() {
  ...
  vi.doMock('@/pages/hooks/message/use-message-inbox-refresh', () => ({
    useMessageInboxRefresh: () => refreshInbox,
  }))

  const authStoreModule = await import('@/pages/objects/auth/use-auth-store')
  const messageStoreModule = await import('@/pages/objects/message/use-message-store')
  const hookModule = await import('@/pages/hooks/message/use-message-realtime-connection')
